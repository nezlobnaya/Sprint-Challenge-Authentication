...
- [x] What does bcrypt do to help us store passwords in a secure manner.
        ...
        Bcrypt hashes the passwords using a technique called Key Stretching.
...
- [x] What does bcrypt do to slow down attackers?
    ...
    It automatically salts the passwords, and repeats the hashing process using work factor set by a developer
